...
let tests =
  [
    ...
    make_test "string" {| " " |} {|" "|};  
    make_test "if1" "if true then 22 else 0" "22";
    make_test "if2" "if true && true then 22 else 0" "22";
    ...
    make_test "basic sequence" "(); true" "true";
